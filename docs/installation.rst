...
The sources for metamoth can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/mbsantiago/metamoth
.. _tarball: https://github.com/mbsantiago/metamoth/tarball/master
